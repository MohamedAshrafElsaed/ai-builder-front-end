...
const NAV_ITEMS = [
    {label: "Overview", href: "/app", icon: HomeIcon, badge: ''},
    {label: "Projects", href: "/app/projects", icon: FolderIcon, badge: ''},
    {label: "UI Designer", href: "/app/ui-designer", icon: PaletteIcon, badge: ''},
    {label: "Chat", href: "/app/chat", icon: ChatIcon, badge: ''},
                    ...
                    >
                        ...
                        {!collapsed && (
                            <span className="ml-3 flex-1 flex items-center justify-between">
                                ...
                                {item.badge && (
                                    <span
                                        className="px-1.5 py-0.5 text-[10px] font-semibold rounded bg-accent-primary/20 text-accent-primary">
                                        {item.badge}
                                    </span>
                                )}
                            </span>
